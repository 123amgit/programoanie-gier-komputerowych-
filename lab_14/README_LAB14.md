...
## Pliki najważniejsze do sprawdzenia przez prowadzącego
...
```text
[ ] Projekt uruchamia się bez błędów w konsoli Godot.
[ ] GameManager jest widoczny jako Autoload.
[ ] HUD pokazuje wynik, HP i życia.
[ ] Fale przeciwników nadal działają.
[ ] Boss jest obecny w main.tscn.
[ ] Boss ma dwa hitboxy.
[ ] Boss używa FSM z IDLE, ATTACK, RETREAT, DEATH.
[ ] Przy połowie HP boss przełącza hitbox na fazę 2.
[ ] Po śmierci bossa pojawia się eksplozja GPUParticles3D.
[ ] Śmierć bossa otwiera ekran level_complete.
```

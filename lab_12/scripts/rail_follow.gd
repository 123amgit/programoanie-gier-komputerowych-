...
# ============================================================
# LAB 09/10/11/12 - RUCH PO SZYNIE
# ============================================================
# Ten skrypt jest przypięty do węzła RailFollow.
# RailFollow jest dzieckiem Path3D, a statek i CameraTarget są dziećmi RailFollow.
# Dzięki temu gracz i idealny punkt kamery lecą automatycznie do przodu po szynie.
#

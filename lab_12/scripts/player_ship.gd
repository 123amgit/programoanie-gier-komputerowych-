...
# Lokalny system życia do Lab 12. Pełny GameManager ma pojawić się później.
...
func _ready() -> void:
	...
	print("PlayerShip gotowy. HP = ", hp, ". Q = barrel roll.")
...
func _take_damage(amount: int) -> void:
	# Najważniejszy warunek Lab 12: podczas barrel roll statek nie traci HP.
	if _is_invincible:
	...
	hp -= amount
	hp = maxi(hp, 0)
	print("Statek otrzymał obrażenia: -", amount, " | HP = ", hp, "/", max_hp)
